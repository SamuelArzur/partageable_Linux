...
static int calcul(int data1, int data2, std::string composant){
...
int main(int argc, char ** argv)
{
	...
	ret=calcul(data1,data2,argv[1]);


	std::cout << std::endl << "Valeur :" << ret << std::endl;
}
